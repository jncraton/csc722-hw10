...
$(SRC).pdf: $(SRC).md
	pandoc --toc --variable documentclass=extarticle --variable fontsize=12pt --variable mainfont="FreeSans" --variable mathfont="FreeMono" --variable monofont="FreeMono" --variable monofontoptions="SizeFeatures={Size=8}" --no-highlight --mathjax --pdf-engine=xelatex -s -o $@ $< 
